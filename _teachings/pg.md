...
| 12.03. | Block partitions and primitive groups. *Theorem:* A transitive group $G\le \textrm{Sym}(\Omega)$ is primitive if and only if $G_\alpha$ is a maximal subgroup, for every $\alpha\in\Omega$. Orbitals of $G\leq \textrm{Sym}(\Omega)$. Bijeciton between the orbitals of $G$ and the orbits of $G_\alpha$. |
| 19.03. | Informal discussion about the Weisfeiler-Leman algorithm. *Higman's theorem:* A transitive group $G\le \textrm{Sym}(\Omega)$ is primitive if and only if $\textrm{diGraph}(\Delta)$ is connected, for every orbital $\Delta$ of $G$. |
