...
<a href="{{ '/assets/teaching/pg/pg.pdf' | relative_url }}" target="_blank">Lecture notes</a><br>
<a href="{{ '/assets/teaching/pg/pg-problems.pdf' | relative_url }}" target="_blank">Homework</a>
...
|------|---------|------|
| 19.02. | _No lecture._ |
| 26.02. | Two motivating examples: finite groups of isometries of $\mathbb{R}^2$ and $\mathbb{R}^3$, automorphism groups of trees. Graph isomorphism problem and how it motivates the study of finite permutation groups. Definition of group action and discussion about notation. |
| 05.03. | Testing isomorphism of colored graphs with bounded sizes of color classes. Some basic definitions and examples of groups actions. |
| 12.03. | Block partitions and primitive groups. _Theorem:_ A transitive group $G\le \textrm{Sym}(\Omega)$ is primitive if and only if $G_\alpha$ is a maximal subgroup, for every $\alpha\in\Omega$. Orbitals of $G\leq \textrm{Sym}(\Omega)$. Bijeciton between the orbitals of $G$ and the orbits of $G_\alpha$. |
| 19.03. | Informal discussion about the Weisfeiler-Leman algorithm. _Higman's theorem:_ A transitive group $G\le \textrm{Sym}(\Omega)$ is primitive if and only if $\textrm{diGraph}(\Delta)$ is connected, for every orbital $\Delta$ of $G$. |
| 26.03. | Testing isomorphism of cubic graphs (part one): reduction to color-preserving subgroup problem for $2$-groups. |
| 02.04. | Testing isomorphism of cubic graphs (part two): divide-and-conquer solution to the color-preserving subgroup problem for $2$-groups. |
| 09.04. | Semidirect product, wreath product, imprimitive action of wreath product. |
| 16.04. | |
| 23.04. | |
| 30.04. | |
| 07.05. | |
